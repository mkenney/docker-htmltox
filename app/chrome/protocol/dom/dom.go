...
type GetNodeForLocationParams struct {
	...
	IncludeUserAgentShadowDOM boolean `json:"includeUserAgentShadowDOM"`
}
...
/*
DocumentUpdatedEvent represents Debugger.documentUpdated event data.
*/
type DocumentUpdatedEvent struct{}

/*
SetChildNodesEvent represents Debugger.setChildNodes event data.
*/
...
/*
AttributeModifiedEvent represents Debugger.attributeModified event data.
*/
...
/*
AttributeRemovedEvent represents Debugger.attributeRemoved event data.
*/
...
/*
InlineStyleInvalidatedEvent represents Debugger.inlineStyleInvalidated event data.
*/
...
/*
CharacterDataModifiedEvent represents Debugger.characterDataModified event data.
*/
...
/*
ChildNodeCountUpdatedEvent represents Debugger.childNodeCountUpdated event data.
*/
...
/*
ChildNodeInsertedEvent represents Debugger.childNodeInserted event data.
*/
...
/*
ChildNodeRemovedEvent represents Debugger.childNodeRemoved event data.
*/
...
/*
ShadowRootPushedEvent represents Debugger.shadowRootPushed event data.
*/
...
/*
ShadowRootPoppedEvent represents Debugger.shadowRootPopped event data.
*/
...
/*
PseudoElementAddedEvent represents Debugger.pseudoElementAdded event data.
*/
...
/*
PseudoElementRemovedEvent represents Debugger.pseudoElementRemoved event data.
*/
...
/*
DistributedNodesUpdatedEvent represents Debugger.distributedNodesUpdated event data.
*/
